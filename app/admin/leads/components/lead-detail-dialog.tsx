...
import { SCORE_ITEMS } from "../constants/leads"
...
export function LeadDetailDialog({ lead, isOpen, onClose }: LeadDetailDialogProps) {
  ...
  const scoreBreakdown = (lead.scoreBreakdown as any) || {}
      ...
      <DialogContent className="max-h-[90vh] max-w-4xl overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {lead.notes && (
              <div className="mb-4 rounded-lg bg-gray-50 p-4 text-sm whitespace-pre-wrap text-gray-700">
                {lead.notes}
              </div>
            )}
