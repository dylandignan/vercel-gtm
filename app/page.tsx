    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-medium tracking-tight text-black mb-4">
            Vercel Sales Platform
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="/contact" className="group">
            <div className="rounded-lg border border-gray-200 p-8 hover:border-gray-300 hover:shadow-md transition-all duration-200">
              ...
              <div className="text-sm font-medium text-black group-hover:text-gray-700">
                Start your journey →
              </div>
            </div>
          </Link>
          ...
          <Link href="/admin/leads" className="group">
            <div className="rounded-lg border border-gray-200 p-8 hover:border-gray-300 hover:shadow-md transition-all duration-200">
              ...
              <p className="text-gray-600 mb-4">
                Access the lead management dashboard to view, score, and manage all incoming sales leads with AI-powered insights and recommendations.
              </p>
              <div className="text-sm font-medium text-black group-hover:text-gray-700">
                View leads →
              </div>
